...
| ![Latest Version](https://img.shields.io/badge/version-5.17.0-blue) |
...
│   ├── TriggerBuilder.php
│   └── WildcardMatcher.php
├── tests/                      # 285 test files + 5 support files
...
│   └── ... (285 test files)
└── Total: 326 PHP files (33 src + 285 tests + 1 rector.php + 1 config + 6 factories/migrations)
```
