...
| ![Latest Version](https://img.shields.io/badge/version-5.36.0-blue) |
...
│   └── ... (299 test files)
└── Total: 345 PHP files (33 src + 299 tests + 5 test support + 1 rector.php + 1 config + 3 factories + 3 migrations)
```
