...
│   ├── TriggerBuilder.php
│   └── WildcardMatcher.php
├── tests/                      # 292 test files + 5 support files
...
│   └── ... (292 test files)
└── Total: 338 PHP files (33 src + 292 tests + 1 rector.php + 1 config + 6 factories/migrations + 5 support)
```
...
```bash
composer test        # Run Pest test suite (292 test files)
