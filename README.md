...
```bash
composer test        # Run Pest test suite (108 test files)
...
- **Fixed**: README test file count corrected from 104 to 108 (4 new test files added since last count).
- **Changed**: Version bumped to 1.79.0.
