...
test('phpstan.neon.dist exists and contains level 9', function (): void {
    ...
    expect(File::exists($path))->toBeTrue('phpstan.neon.dist must exist for PHPStan 9');
...
test('phpstan.neon.dist reportUnmatchedIgnoredErrors is false', function (): void {
    $content = file_get_contents(__DIR__.'/../phpstan.neon.dist');

    expect($content)->toContain('reportUnmatchedIgnoredErrors: false');
});
