...
uses(TestCase::class)->in('ActionResolverTest.php', 'ConditionEngineTest.php', 'DispatchTriggerJobTest.php', 'EventLogTest.php', 'EventManagerTest.php', 'TriggerModelTest.php', 'SubscriptionTest.php');
