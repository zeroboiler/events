...
uses(TestCase::class)->in('ActionResolverTest.php', 'ConditionEngineTest.php', 'DispatchTriggerJobTest.php', 'DomainEventTest.php', 'EdgeCasesTest.php', 'EdgeCasesPhase2Test.php', 'EventHistoryStatsTest.php', 'EventLogTest.php', 'EventManagerIntegrationTest.php', 'EventManagerParseActionsTest.php', 'EventManagerTest.php', 'EventsServiceProviderTest.php', 'SubscriptionBuilderTest.php', 'SubscriptionTest.php', 'TriggerBuilderExtendedTest.php', 'TriggerModelTest.php');
