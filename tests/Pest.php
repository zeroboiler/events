...
uses(TestCase::class)->in('ActionResolverTest.php', 'ConditionEngineTest.php', 'ConfigCompletenessTest.php', 'DispatchTriggerJobTest.php', 'DomainEventTest.php', 'EdgeCasesTest.php', 'EdgeCasesPhase2Test.php', 'EventsComprehensiveTest.php', 'EventsEdgeCaseTest.php', 'EventsFacadeProxyTest.php', 'EventsFinalClassesTest.php', 'EventHistoryStatsTest.php', 'EventLogTest.php', 'EventManagerCacheTtlTest.php', 'EventManagerIntegrationTest.php', 'EventManagerParseActionsTest.php', 'EventManagerTest.php', 'EventsRedeliverCommandTest.php', 'EventsServiceProviderTest.php', 'ProductionReadyTest.php', 'ServiceProviderBindingTest.php', 'SubscriptionBuilderTest.php', 'SubscriptionSignConfigTest.php', 'SubscriptionTest.php', 'TraitConsistencyTest.php', 'TriggerBuilderExtendedTest.php', 'TriggerModelTest.php', 'TypedPropertiesTest.php', 'WildcardIntegrationTest.php');
