...
uses(TestCase::class)->in('ActionResolverTest.php', 'ConditionEngineTest.php', 'EventLogTest.php', 'EventManagerTest.php', 'TriggerBuilderTest.php', 'TriggerModelTest.php', 'SubscriptionTest.php');
