...
uses(TestCase::class)->in('ActionResolverTest.php', 'ConditionEngineTest.php', 'EventLogTest.php', 'EventManagerTest.php', 'TriggerModelTest.php', 'SubscriptionTest.php', 'UuidGenerationTest.php', 'Issue3PartialDispatchTest.php', 'Issue7RaceConditionTest.php', 'ConsoleCommandTest.php', 'EventsCleanupCommandTest.php', 'IssueFixesTest.php', 'BugFixTest.php');
