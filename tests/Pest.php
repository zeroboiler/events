...
uses(TestCase::class)->in('ActionResolverTest.php', 'ConditionEngineTest.php', 'DispatchTriggerJobTest.php', 'DomainEventTest.php', 'EventLogTest.php', 'EventManagerTest.php', 'TriggerBuilderExtendedTest.php', 'TriggerModelTest.php', 'SubscriptionTest.php');
