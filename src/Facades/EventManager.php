 ...
 * @method static Collection<int, Trigger> listTriggers(?string $event = null, ?bool $enabled = null, int $limit = 100)
 * @method static Trigger|null getTrigger(string $triggerId)
