    ...
    protected function evaluateCondition(string $field, mixed $expected, array $payload): bool
    {
        ...
        if (is_array($expected)) {
            ...
            return match ($operator) {
                ...
                'empty' => $actual === null || $actual === '' || $actual === 0 || $actual === '0' || $actual === false || (is_array($actual) && $actual === []),
                'not_empty' => $actual !== null && $actual !== '' && $actual !== 0 && $actual !== '0' && $actual !== false && (! is_array($actual) || $actual !== []),
